...
from api_v1.project_classes.team.views import router as team_router, manager_team_router

from api_v1.project_classes.match.views import (
...
from api_v1.project_classes.tournament.views import (
